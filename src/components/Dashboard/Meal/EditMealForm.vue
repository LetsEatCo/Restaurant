  ...
  >
    ...
    >
      ...
      <div :style="{display: informationsTabVisible ? 'block' : 'none'}">
        ...
        >
          <el-select
            v-model="form.optionProductUuid"
            :placeholder="form.optionProductUuid"
      ...
      <div :style="{display: subsectionsTabVisible ? 'block' : 'none'}">
        ...
        >
          ...
          <el-form-item
            label="Ingredient"
            v-for="(optionIngredient, optionIndex) in subsection.options.ingredients"
            :key="optionIndex"
          >
            <el-select
              v-model="optionIngredient.optionIngredientUuid"
              :placeholder="optionIngredient.ingredient.name"
            >
          ...
          <el-form-item
            label="Product"
            v-for="(optionProduct, productIndex) in subsection.options.products"
            :key="productIndex"
          >
            <el-select
              v-model="optionProduct.optionProductUuid"
              :placeholder="optionProduct.product.name"
            >
              <el-option
                v-for="product in getProducts"
                :key="product.uuid"
