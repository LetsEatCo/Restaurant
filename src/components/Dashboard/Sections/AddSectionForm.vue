...
<script>
	...
	import {STORE_CREATE_SECTION_REQUEST} from '../../../store/actions/store/store.sections.actions';
	...
	export default {
		...
		methods: {
			...
			closeForm() {
				this.formVisible
					? eventBus.$emit('addSectionFormVisible', false)
					: eventBus.$emit('addSectionFormVisible', true);
