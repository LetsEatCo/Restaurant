<template>
	<el-dialog title="Edit Ingredient" custom-class="Actions__edit-dialog" :visible.sync="formVisible" top="30vh"
						 width="35%" @close="closeForm()">
		<el-form ref="form" :model="form">
			<el-form-item label="Ingredient Name">
				<el-input placeholder="Eg. Salad" v-model="form.name" autocomplete="off">{{form.name}}</el-input>
			</el-form-item>
			<el-form-item label="Quantity">
				<el-input placeholder="Ingredient quantity available in your stock" v-model="form.quantity"
									autocomplete="off">{{form.name}}
				</el-input>
			</el-form-item>
		</el-form>
		<div slot="footer">
